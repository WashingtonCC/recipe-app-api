...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        serializer = RecipeSerializer(recipes, many=True) # Serializers can return a list
        self.assertEqual(res.status_code, status.HTTP_200_OK) # of items if many=True is specified.
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'Lettuce'}, {'name': 'Salt'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        params = {'tags': f'{tag1.id},{tag2.id}'} # custom query params
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            ...
            # multipart because it contains text and also binary data
            # the file created by tempfile will be deleted once outside the with
